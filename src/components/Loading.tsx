...
const Loading:FC = () => {
    return(
        <motion.div initial={{opacity:1}} exit={{opacity:0}} transition={{duration: 1}} className='absolute top-0 left-0 w-screen h-screen z-[100] bg-[#f1f1f1]'>
            <div className='absolute top-[calc(50%-50px)] left-[calc(50%-50px)]'>
                <LoadingSVG color="#000" width="100" height="100" />
            </div>
        </motion.div>
    )
}

const LoadingSVG:FC<{color:string,width:string,height:string}> = ({color,width,height}) => {
    return(
        <svg fill={color} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
            width={width} height={height} viewBox="0 0 418.879 418.879">
        <g>
            <g>
                <motion.path initial={{rotate: 0}} animate={{rotate:360}} transition={{duration: 3}} d="M188.634,234.066c8.462-5.287,16.126-11.735,22.767-19.127l23.942,13.826l21.8-37.76l-23.894-13.796
                ...
                <motion.path initial={{rotate: 0}} animate={{rotate: -360}} transition={{duration: 3}} d="M376.041,266.807l-18.795,6.08c-3.584-6.229-8.014-11.869-13.115-16.779l10.504-16.764l-26.447-16.57l-10.498,16.75
                ...
                <motion.path initial={{rotate: 0}} animate={{rotate:360}} transition={{duration: 3}} d="M418.146,158.647l0.732-24.629l-15.586-0.463c-0.977-5.428-2.723-10.803-5.285-15.971l12.24-9.67l-15.271-19.33
